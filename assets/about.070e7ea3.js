import{o as c,t as s,e as p}from"./index.6771e6ed.js";const f=s(`<div class="grid grid-cols-1 gap-4 place-items-center "><h1 class=text-9xl>About</h1><pre id=pre class=mermaid>graph LR
A --- B
