import{o as c,t as s,n as p}from"./index.f5d3ac10.js";const f=s(`<div class="grid grid-cols-1 gap-4 place-items-center "><h1 class=text-9xl>About</h1><pre id=pre class=mermaid>graph LR
A --- B
